  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-4">
        {/* 会社概要 */}
        <h2 className="text-4xl font-bold bg-gradient-to-r from-blue via-blue-100 to-white bg-clip-text  mb-4">
             会社概要 <br />
            <span className='text-xl '>Company Profile</span>
          </h2>
        <table className="w-full text-left border border-gray-300 mb-10">
          <tbody>
            <tr className="border-b"><th className="p-2 bg-gray-100 w-1/4">会社名</th><td className="p-2">One Step株式会社（One Step Co., Ltd.）</td></tr>
            ...
            <tr className="border-b"><th className="p-2 bg-gray-100">取引銀行</th><td className="p-2">三菱UFJ銀行、〇〇信用金庫ほか</td></tr>
            <tr className="border-b"><th className="p-2 bg-gray-100">許可・登録</th><td className="p-2">有料職業紹介事業許可（厚生労働大臣 許可番号：〇〇-ユ-〇〇〇〇）｜ その他関連業登録準備中</td></tr>
            <tr className="border-b"><th className="p-2 bg-gray-100">ミッション</th><td className="p-2">「その一歩が、未来を変える」外国人と企業の架け橋となり、日本社会に信頼される人材流通を実現します。</td></tr>
            <tr className="border-b"><th className="p-2 bg-gray-100">ビジョン</th><td className="p-2">多様な人材が活躍できる社会を目指し、“人”を中心にした価値創造を追求します。</td></tr>
            <tr><th className="p-2 bg-gray-100">ロゴ・スローガン</th><td className="p-2">ロゴ：※ここにロゴ画像 ｜ スローガン：「その一歩が、未来を変える」</td></tr>
          </tbody>
        </table>
