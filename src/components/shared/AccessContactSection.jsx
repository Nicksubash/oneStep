            ...
            <div className="space-y-3">
              {phone && (
                <p className="flex items-center text-gray-700">
                  ...
                  <a href={`tel:${phone}`} className='text-lg text-brand-navy hover:underline'>{phone}</a>
                </p>
              )}
              {fax && (
                <p className="flex items-center text-gray-700">
              ...
              {email && (
                <p className="flex items-center text-gray-700">
                  ...
                  <a href={`mailto:${email}`} className="text-lg text-brand-navy hover:underline">{email}</a>
                </p>
              )}
            </div>
          </div>
