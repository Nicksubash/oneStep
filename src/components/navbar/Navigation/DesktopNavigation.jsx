          ...
          {navLinks.map((link, index) => (
            ...
            >
              <a
                ...
                className={`relative px-6 py-4 text-xl font-medium transition-all duration-300 flex items-center justify-center min-w-[160px] ${activeLink === link.name
              ...
              >
                <span className="relative z-10 flex flex-col items-center leading-tight">
                  <span className="text-xl font-semibold whitespace-nowrap">{link.name}</span>
                  {link.subtitle && (
                    <span className="text-xs text-gray-400 -mt-1 whitespace-nowrap">{link.subtitle}</span>
                  )}
                </span>
              </a>
